...
Run the chunk below to process real-world observations 
```{r processing real-world observations}
# processObsData=T
if(params$processObsData) rmarkdown::render("observation-preparation.Rmd",
                                     output_dir=outputDir, quiet = T)
```

Run the chunk below to process simulation outputs
```{r processing simulation outputs}
# processSimData=TRUE
if(params$processSimData) rmarkdown::render("simOutputPorcessing.Rmd",
