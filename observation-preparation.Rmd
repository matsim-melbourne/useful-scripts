...
paths <- dir_ls("./data/calibration-validation/data/observations/bicycle/2018-03/",glob = "*.zip" )
...
cycleCountersMeta <- read_xlsx("./data/calibration-validation/data/observations/bicycle/VicRoads_Bike_Site_Number_Listing.xlsx",
...
walkData <- read_csv("./data/calibration-validation/data/observations/walk/Pedestrian_Counting_System_-_Monthly__counts_per_hour_.csv", col_types = col_spec) 
...
walkSensorLocs <- read_csv("./data/calibration-validation/data/observations/walk/Pedestrian_Counting_System_-_Sensor_Locations.csv", col_types = col_spec)
...
stationData <- readxl::read_excel("./data/calibration-validation/data/observations/pt/2016 Station Access Mode.xlsx",sheet = "Sheet2", skip = 3)  
...
stationLocations <- read_csv("./data/calibration-validation/data/observations/pt/stops.txt", col_types = col_spec) %>% 
  mutate(stationID=as.character(stop_id)) %>% 
  dplyr::select(stationID, stop_lat, stop_lon)
...
stationDataCoordinated <- stationDataFiltered %>% 
  left_join(stationLocations, by="stationID")
